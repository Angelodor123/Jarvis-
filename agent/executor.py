...
def _run_generated_code(description: str, speak: Callable | None = None, confirmed: bool = False) -> str:
    import google.generativeai as genai

    # Security gate: require confirmation before executing generated code
    if not confirmed and speak:
        speak(f"Sir, I am about to run generated code to: {description[:80]}. Please confirm by saying: confirmed.")
        return "Awaiting confirmation before executing generated code."

    if speak:
        speak("Confirmed. Writing and executing code now, sir.")
...
def _call_tool(tool: str, parameters: dict, speak: Callable | None) -> str:
    ...
    elif tool == "portfolio_tracker":
        from actions.portfolio_tracker import portfolio_tracker
        return portfolio_tracker(parameters=parameters, player=None, speak=speak) or "Done."

    elif tool == "calendar_email":
        from actions.calendar_email import calendar_email
        return calendar_email(parameters=parameters, player=None, speak=speak) or "Done."
