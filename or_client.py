...
class OpenRouterClient:
    ...
    def __init__(self) -> None:
        ...
        self._headers = {
            ...
            "HTTP-Referer":  "https://github.com/dorbareket/mark-xxxix-or",
    ...
    def chat(
        ...
        prompt: str,
        system: str = (
            "You are a component of MARK XXXIX-OR, Dor Bareket's personal AI assistant inspired by JARVIS. "
...
if __name__ == "__main__":
    print("=" * 55)
    print("  MARK XXXIX-OR — OpenRouter Client Self-Test")
    print("=" * 55)
